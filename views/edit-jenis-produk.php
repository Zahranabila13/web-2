<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $data = JenisProduk::update($data, $id);
        header('Location: list-jenis-produk.php');
        exit;
    }
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $jenis_produk['nama'] ?>" required />
                                </div>
                                <div class="mb-3">
                                    <label for="persen_diskon" class="form-label">Deskripsi</label>
                                    <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="5" required><?php echo $jenis_produk['deskripsi'] ?></textarea>
                                </div>
